  ...
  <div className="collapse navbar-collapse  "  id="navbarNavDropdown">
    <ul className="navbar-nav  ">
      <li className="nav-item active ">
        <a className="nav-link text-black  fs-6 " href="#">
          Home
           {/* <span className="sr-only">(current)</span> */}
        </a>
      </li>
      <li className="nav-item ">
        <a className="nav-link text-black fs-6" href="#About">
          About
        </a>
      </li>
      <li className="nav-item">
        <a className="nav-link text-black fs-6" href="#Skills">
          Skills  
        </a>
      </li>
      <li className="nav-item">
        <a className="nav-link text-black fs-6 " href="#Projects">
          Projects  
        </a>
      </li>
    {/*  <li className="nav-item dropdown">
        ...
        <div className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          <a className="dropdown-item text-black fs-6" href="#">
            LeetCode
          </a>
          <a className="dropdown-item text-black fs-6" href="#">
            Geeks For Geeks
